...
class Speech2Text:
    ...
    def __init__(
        ...
        task = ASRBASETask if not enh_s2t_task else EnhS2TTask
...
def inference(
    ...
    loader = ASRBASETask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=ASRBASETask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=ASRBASETask.build_collate_fn(speech2text.asr_train_args, False),
